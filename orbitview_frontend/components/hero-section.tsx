      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <motion.p 
            ...
            variants={fadeIn}
          >
            Access curated events, competitions, and programs designed to help you reach new heights in your professional journey.
          </motion.p>
          ...
          >
            ...
            <Button size="lg" className="w-full sm:w-auto whitespace-nowrap rounded-full px-8">
              Find Opportunities
            </Button>
          </motion.div>
          ...
          >
            {[
              ...
              { label: "Browse Competitions", href: ROUTES.COMPETITIONS },
              { label: "Discover Programs", href: ROUTES.PROGRAMS },
            ].map((item) => (
